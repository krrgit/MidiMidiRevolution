        ...
        Uint8: function(FileAsUint8Array){
            ...
            for(let t=1; t <= MIDI.trackCount; t++){
                ...
                while(!endOfTrack){
                    ...
                    let deltaTime  = file.readIntVLV();      // get DELTA TIME OF MIDI event (Variable Length Value)
                    ...
                    if(statusByte === 0xFF){                                        // Meta Event type
                        let metaType = file.readInt(1);     // assign metaEvent subtype
                    ...
                    //
                        ...
                        let type = parseInt(statusByte[0], 16);// first byte is EVENT TYPE ID
                        let channel = parseInt(statusByte[1], 16);// second byte is channel
                        switch(type){
                            ...
                            case 0x8:                                               // Note off
                            case 0x9:                                               // Note On
                                let notenumber = file.readInt(1);
                                let velocity = file.readInt(1);
                                console.log('note(s)');
